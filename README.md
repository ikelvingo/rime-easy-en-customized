...
> [!NOTE]
>
> - 本方案的英语长句输入并非使用wordninja，而是采用词典内置的方式，目前内置了10多万的常用词组或谚语。使用该功能时，直接连续输入字母，无需在词汇间增加空格。
> 	
...
> [!TIP]
>
> - ps1: opencc目录中的excel是用于维护和定制词库的，可能在导出和制作词库、辞典文件时，需要一点点的excel技巧
> - ps2: ico目录里是本人网上找的几个无版权问题可免费使用的icon自己改的，欢迎使用
